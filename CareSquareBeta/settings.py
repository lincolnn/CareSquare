...
DATABASES = {
    'default': {
        ...
        'NAME': 'caresquarebeta',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'dds2=b5$f$y26o#*h)fe8dnbp#-_n+svnlm2%2kcn2$f&6%o%*'
...
ROOT_URLCONF = 'CareSquareBeta.urls'
